...
// 🎯 Why: TickerTape renders a list of items that could be re-rendered frequently. Re-creating formatting objects and calling .toLocaleString() inside the map loop for every ticker was causing unnecessary CPU overhead.
