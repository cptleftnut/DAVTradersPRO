...
// ⚡ Bolt: Cache Intl.NumberFormat instance outside the component to prevent recreating it on every render loop.
// 🎯 Why: TickerTape maps over double the array length to render its infinite scroll. Re-creating formatting objects and calling .toLocaleString() inside the map loop causes unnecessary CPU overhead.
// 📊 Impact: Significantly reduces layout calculation time and CPU usage by reusing the pre-configured formatter object.
