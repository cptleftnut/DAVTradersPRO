...
// 🎯 Why: TickerTape maps over a large list of tickers. Re-creating formatting objects and calling .toLocaleString()
// inside the map loop for every ticker caused unnecessary CPU overhead during the render cycle.
