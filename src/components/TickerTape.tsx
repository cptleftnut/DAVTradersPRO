...
// 🎯 Why: TickerTape renders many items and updates frequently. Re-creating formatting objects and calling .toLocaleString()
// inside the map loop for every ticker was causing unnecessary CPU overhead during the render cycle.
