...
// ⚡ Bolt: Cached Intl.NumberFormat instances for much faster number formatting
// inside the frequent render loop of the OrderBook (updates every 100ms).
              ...
              {asks.map((ask, i) => {
                ...
                return (
                  <div key={`ask-${i}`} className="relative grid grid-cols-3 px-2 py-0.5 group hover:bg-gray-800/50">
                     ...
                     <div className="text-gray-300 text-right z-10">{priceFormatter.format(amt)}</div>
