  ...
  return (
    <div className="fixed bottom-6 right-6 z-[200]">
      ...
      <button
        ...
        className="bg-amber-500 text-black p-4 rounded-full shadow-lg hover:bg-amber-400 transition-all flex items-center justify-center hover:scale-105 active:scale-95 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-black focus-visible:ring-offset-2 focus-visible:ring-offset-amber-500"
